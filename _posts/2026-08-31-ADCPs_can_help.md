---
title: What altimetry can’t do ADCPs can.
mathjax: true
layout: post
categories: media
...
![ExSeas_meanField.jpeg](/assets/ExSeas_meanField.jpeg)
...
These are tough times in science, but perhaps we can use the time to regroup? We need to create a framework or culture that embraces a partnership with the merchant marine for ocean study. It’s not just ADCPs, it can be whatever tools we can develop optimized for ocean study in the MM-environment (Rossby et al., 2019). We all agree that sustained observation is essential, but we lack the institutional infrastructure to realize this need. This is perhaps the overarching challenge facing us. 
